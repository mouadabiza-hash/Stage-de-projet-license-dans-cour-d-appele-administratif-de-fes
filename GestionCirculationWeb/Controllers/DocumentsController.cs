...
public async Task<IActionResult> GetDocumentsForCurrentService()
{
    ...
    foreach (var e in juds)
    {
        ...
        // 🔥 CORRECTION : Construire le numeroDossier UNIQUEMENT à partir de NumeroDossier
        ...
        // 🔥 SUPPRIMER la partie qui utilise IdBureauOrdre comme fallback
        ...
        result.Add(new
        {
            ...
            numeroDossierJudiciaire = numeroDossier  // ← Peut être null
        });
    }
