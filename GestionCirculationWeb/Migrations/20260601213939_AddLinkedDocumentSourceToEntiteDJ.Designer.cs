...
namespace GestionCirculationWeb.Migrations
{
    ...
    [Migration("20260601213939_AddLinkedDocumentSourceToEntiteDJ")]
    partial class AddLinkedDocumentSourceToEntiteDJ
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GestionCourrier.Models.EntiteDJ", b =>
                {
                    ...
                    b.Property<bool>("EstDocumentLie")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("LinkedDocumentSource")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("ParentJudiciaireId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionCourrier.Models.EntiteDJ", b =>
                {
                    ...
                    b.HasOne("GestionCourrier.Models.EntiteDJ", "ParentJudiciaire")
                        .WithMany("DocumentsLies")
                        .HasForeignKey("ParentJudiciaireId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("EntiteAdministratif");

                    b.Navigation("ParentJudiciaire");
