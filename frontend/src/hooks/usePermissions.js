...
const PERMISSIONS = {
  ...
  Greffier:       { canCreate:true,  canDelete:true,  canArchive:false, canTransfer:true,  canExport:false, canManageUsers:false, canManageServices:false, canManageEquipments:true,  canViewUsers:false, canViewServices:false, canViewEquipments:true,  canCreateAdministratif:true,  canCreateJuridique:true ,canSeeAdministrateur:true},
