...
function GererEquipements() {
    ...
    // Dynamic lists from central ListItems table
    ...
    useEffect(() => {
        const fetchLists = async () => {
            try {
                ...
                // No fallback – dropdowns will be empty
            }
        };
        fetchLists();
    }, []);
    ...
    // Helper to get display label from list
            ...
            <div className="form-card">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-grid">
                        ...
                        <div className="form-field">
                            <label>{t('etat')} *</label>
                            <select value={form.etat} onChange={e => setForm({ ...form, etat: e.target.value })} required>
                                <option value="">{t('etat')}</option>
                                {equipmentEtats.map(etat => (
                                    <option key={etat.code} value={etat.code}>
                                        {locale === 'ar' ? etat.valueAr : etat.valueFr}
                                    </option>
